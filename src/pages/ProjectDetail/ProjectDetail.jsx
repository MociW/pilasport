    ...
    return (
        <>
            ...
            <section className="flex justify-center mb-20">
                <div>
                    <div className="fixed lg:h-[500px] h-[400px]">
                        <div className="mb-4">
                            <img
                                src={mainImage}
                                alt=""
                                className="lg:w-[350px] lg:h-[350px] md:w-[250px] md:h-[250px] rounded-lg object-cover"
                            />
                        </div>
                        <Gallery
                            images={project.img}
                    ...
                    <div className="lg:w-[500px] w-[300px] relative lg:ml-[400px] ml-[300px]">

...
const ProductDetail = () => {
    const { id } = useParams();
    const project = products.find((data) => data.name.toLowerCase().replace(/\s/g, "-") === id);
    ...
    return (
        <>
            ...
            <section className="flex justify-center mb-20">
                <div className="flex gap-8 w-[970px]">
                    {/* Left Side - Sticky Gallery */}
                    <div className="w-[400px] sticky top-[120px] self-start">
                        <div className="mb-4">
                            <img src={mainImage} alt="" className="h-[400px] w-[400px] object-cover rounded-lg" />
                        </div>

...
const ProjectOverview = () => {
    ...
    return (
        <section className="bg-white">
            <div className="relative pt-20 pb-10 lg:pb-20 lg:flex lg:justify-center lg:items-center">
                <div className="lg:w-[970px] mx-4 lg:mx-0 bg-[#F3F3F3] rounded-lg shadow-lg lg:h-[480px] relative">
                    <div className="relative z-10 px-4 pt-10 lg:px-0">
                        ...
                        <div className="flex flex-col items-center justify-center gap-6 lg:flex-row-reverse lg:items-end lg:gap-10">
                            {/* Image Card */}
                            ...
                            {/* Text Content */}
                            <div className="w-[470px] lg:w-[340px] text-center lg:text-right">
